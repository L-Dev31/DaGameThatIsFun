...
document.addEventListener('DOMContentLoaded', async () => {
  // Mise à jour du container des joueurs
  ...
  // Mise à jour initiale et périodique toutes les 5 secondes
  await updatePlayers();
  setInterval(updatePlayers, 5000);

  // Gestion de l'intro et de la prévisualisation des jeux
  ...
  let isMuted = true; // Par défaut, le son est muet
  ...
  // Masquer l'intro après 8 secondes
  setTimeout(() => {
